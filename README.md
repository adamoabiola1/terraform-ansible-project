This project various roles use terraform and ansible to deploy apache and time zone on ec2 instances.
...
### NOTE
- `Domain name- abiola-book.me`
- `subdomain name- terraform-test`
- `Link - http://terraform-test.abiola-book.me`
